...
for n_shots in shots:
    lunch_exp(workbook5, real_5, n_qubits=2, cx_map=cx_map_5, num_shots=n_shots)
    time.sleep(2)
    lunch_exp(workbook5, real_5, n_qubits=3, cx_map=cx_map_5, num_shots=n_shots)
    time.sleep(2)
    lunch_exp(workbook5, real_5, n_qubits=5, cx_map=cx_map_5, num_shots=n_shots)
    time.sleep(2)
...
for n_shots in shots:
    lunch_exp(workbook16, real_16, n_qubits=2, cx_map=cx_map_16, num_shots=n_shots)
    time.sleep(2)
    lunch_exp(workbook16, real_16, n_qubits=3, cx_map=cx_map_16, num_shots=n_shots)
    time.sleep(2)
    lunch_exp(workbook16, real_16, n_qubits=5, cx_map=cx_map_16, num_shots=n_shots)
    time.sleep(2)
    lunch_exp(workbook16, real_16, n_qubits=7, cx_map=cx_map_16, num_shots=n_shots)
    time.sleep(2)
    lunch_exp(workbook16, real_16, n_qubits=9, cx_map=cx_map_16, num_shots=n_shots)
    time.sleep(2)
